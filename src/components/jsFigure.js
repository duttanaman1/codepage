...
function JsFigure() {
  return (
    <div className="BuildTestDeploy_editorCode-1h1eH BuildTestDeploy_js-2uTqn">
      <header>
        <svg
          width="16"
          height="16"
      ...
      <div className="BuildTestDeploy_codeContent-2IVkO">
        <code>
          <span className="BuildTestDeploy_cy-2_ikO">var</span>
          <span className="BuildTestDeploy_cb-ySNuR">colors</span> = [
          <span className="BuildTestDeploy_cg-3wZAT">"#74B087"</span>,
          <span className="BuildTestDeploy_cg-3wZAT">"#DE7300"</span>,
          <span className="BuildTestDeploy_cg-3wZAT">"#74B087"</span>
          ];
          <br />
          <br />
          <span className="BuildTestDeploy_cc-1lQHb">{"// Do the thing"}</span>
          <br />
          <span className="BuildTestDeploy_cy-2_ikO">function</span>
          <span className="BuildTestDeploy_cb-ySNuR">animate</span>
          {"()"}
          {"{}"}
          {";"}
        </code>

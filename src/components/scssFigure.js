...
function ScssFigure() {
  return (
    <div className="BuildTestDeploy_editorCode-1h1eH BuildTestDeploy_css-zmdqC">
      <header>
        <svg
          width="16"
          height="16"
      ...
      <div className="BuildTestDeploy_codeContent-2IVkO">
        <code>
          <p className="BuildTestDeploy_line1-2FkJ-">
            <span className="BuildTestDeploy_cy-2_ikO">.rect</span>
            <span>{"{"}</span>
          </p>
          <br />
          <p className="BuildTestDeploy_line2-2ZJ18">
            <span className="BuildTestDeploy_cp-3CO2O">background</span>
            <span>:</span>
            <span className="BuildTestDeploy_cy-2_ikO">linear-gradient</span>(
          </p>
          <br />
          <p className="BuildTestDeploy_line3-1jogW">
            <span className="BuildTestDeploy_co-Ug_IC">-119deg</span>,
          </p>
          <br />
          <p className="BuildTestDeploy_line4-1_RtJ">
            <span className="BuildTestDeploy_cy-2_ikO">$gray</span>
            <span className="BuildTestDeploy_co-Ug_IC">0%</span>,
          </p>
          <br />
          <p className="BuildTestDeploy_line5-2G_Wd">
            <span className="BuildTestDeploy_cy-2_ikO">$dark-gray</span>
            <span className="BuildTestDeploy_co-Ug_IC">100%</span>); {"}"}
          </p>
        </code>
      </div>
    </div>
